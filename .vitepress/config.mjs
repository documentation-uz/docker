...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            {text: 'Home', link: '/'},
            {text: 'Tutorial', link: '/tutorial/index', activeMatch: '/tutorial/'},
            {text: 'API reference', link: '/api-reference/index', activeMatch: '/api-reference/'}
        ],
        ...
        sidebar: {
            ...
            // '/api-reference/': [
            //     {
            //         text: 'Dockerfile', link: '/api-reference/dockerfile/',
            //         items: [
